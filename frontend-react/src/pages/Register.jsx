      ...
      <div className="auth-container">
        <div className="auth-card">
          ...
          <form className="auth-form" onSubmit={handleSubmit} noValidate>
            ...
            <div className="form-group">
              <label className="form-label" htmlFor="phone">Phone Number <span style={{ color: 'var(--text-body)', fontWeight: 400 }}>(optional)</span></label>
              <input
                type="tel"
                id="phone"
                name="phone"
            ...
            <div className="form-group">
              <label className="form-label" htmlFor="companyName">Company Name <span style={{ color: 'var(--text-body)', fontWeight: 400 }}>(optional)</span></label>
              <input
                type="text"
                id="companyName"
                name="companyName"
