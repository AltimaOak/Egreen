        ...
        <FadeUp>
          ...
          <div className="contact-info-item">
            ...
            <div>
              ...
              <p style={{ whiteSpace: 'pre-line' }}>{contactData.address || "3rd Floor, A-302, Aakar Nirman Sra Co-Op-Hsg Soc\nVilgml Road Dindoshi, Goregaon East\nMumbai - 400063, Maharashtra, India"}</p>
            </div>
          </div>
          ...
          <div className="contact-info-item">
            ...
            <div>
              ...
              <p>Contact: <a href={`tel:${contactData.phone || '+917942625065'}`} style={{ color: 'inherit', textDecoration: 'none' }}>{contactData.phone || '+91-7942625065'}</a></p>
          ...
          <div className="contact-info-item">
            ...
            <div>
              <h4>Email</h4>
              <p><a href={`mailto:${contactData.email || 'egreentechnology24@gmail.com'}`} style={{ color: 'inherit', textDecoration: 'none' }}>{contactData.email || 'egreentechnology24@gmail.com'}</a></p>
            </div>
          </div>
          ...
          <div className="contact-info-item">
            ...
            <div>
              ...
              <p style={{ whiteSpace: 'pre-line' }}>{contactData.workingHours || "Monday - Saturday: 9:00 AM - 6:00 PM\nSunday: Closed"}</p>
            </div>
          </div>
        </FadeUp>
