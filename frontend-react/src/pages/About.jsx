...
<<<<<<< HEAD
          <h1 className="h1">{aboutData.heroTitle}</h1>
          <p style={{ fontSize: '1.125rem', maxWidth: '600px', margin: '0 auto' }}>{aboutData.heroSubtitle}</p>
        </FadeUp>
      </div>
      ...
      <FadeUp className="container" style={{ padding: '4rem 0' }}>
