    ...
    <footer className="footer">
      <div className="container">
        ...
        <div className="footer-cta-banner">
          ...
          <a href="https://wa.me/919867760106" target="_blank" rel="noreferrer" className="btn btn-primary footer-cta-btn">
            Get Wholesale Quote 
        ...
        <div className="footer-grid">
          ...
          <div className="footer-brand-col">
            ...
            <div className="social-icons">
              ...
              <a href="https://wa.me/919867760106" target="_blank" rel="noreferrer" className="social-badge whatsapp-badge" title="Direct WhatsApp Support">
          ...
          <div>
            ...
            <div className="footer-links">
              ...
              <Link to="/services">IT &amp; Software Services</Link>
          ...
          <div>
            ...
            <div className="footer-contact-list">
              ...
              <a href="tel:+919867760106" className="footer-contact-item">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path></svg>
                <span>+91-9867760106</span>
              </a>
            </div>
          </div>
        </div>
